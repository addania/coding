...
export default ( {data}) => (
  ...
  <Layout>
    ...
    <p>Programming has always been like looking at another galaxy from the surface of Earth and admiring its endless beauty. 
      Something so distant and daunting, yet tempting and mystical. 
      ...
      During my studies I could not really find the true passion and the coding universe has always been lurking somewhere at the back of my mind.
      ...
      After this experience I thought, what if ... What if I could be looking forward to going to work eevery day like this?
